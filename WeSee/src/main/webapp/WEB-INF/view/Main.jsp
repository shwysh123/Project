...
<body class="scroll">
	...
	<div class="buttons-containter" style="z-index: 1;">

		<a href="/myinfo.do"><button
				style="border: 0.5px solid; width: 80px; height: 20px; background-color: white;">내정보</button></a>
		<a href="/logout.do"><button
				style="border: 0.5px solid; width: 80px; height: 20px; background-color: white;">로그아웃</button></a>
	</div>
	...
	<div
		...
		<table style="width: 400px; height: 650px; background-color: black;">
			...
			<tbody class="scroll"
				style="background-color: white; overflow: auto; max-height: 90px; display: block;">
				<tr>
		...
		<table style="width: 400px; height: 650px; background-color: black;">
			...
			<thead>
				...
				<tr>
					<th style="background-color: white; height: 450px;"><div
							class="scroll" style="max-height: 450px; overflow: auto;">글내용(사진,글내용(사진,동영상)글gsdfgsdgbhusidfjhgnsdiujn내용(사진,동영상)글내용(사진,동영상)글내fdsafasdfasdfasdfasdfasdfasdf용(사진,동영상)동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)글내용(사진,동영상)</div></th>
				</tr>
				<tr>
					<th style="display: flex; height: 28px; background-color: white;">
						<div>
